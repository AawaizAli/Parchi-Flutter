...
class AppColors {
  ...
  // Used for: The main Parchi Card Gradient (End color), Active Buttons, Links
  static const Color primary = Color(0xFF007AFF); // A vibrant blue

  // Used for: Leaderboard Top 3 Ranks, Stats Progress Ring on Card Back
  static const Color secondary = Color(0xFFFF9500); // A warm orange

  // Used for: Success messages, "Total Saved" amount text
  static const Color accent = Color(0xFF34C759); // A bright green

  // --- Background/Surface Colors ---
  // Used for: The main App Background (Scaffold)
  static const Color backgroundLight = Color(0xFFF2F2F7); // Light grey background

  // Used for: The Parchi Card Gradient (Start color) to give it that deep, premium look
  static const Color backgroundDark = Color(0xFF1C1C1E); // Dark charcoal background

  // Used for: Search Bar, Bottom Navigation Bar, App Bar background
  static const Color surface = Color(0xFFFFFFFF); // Pure white for cards/surfaces

  // --- Text/Content Colors ---
  // Used for: Main Headings, Restaurant Names, Profile Name
  static const Color textPrimary = Color(0xFF1C1C1E);

  // Used for: Subtitles, Hints, Unselected Icons, "Used" label on Card Back
  static const Color textSecondary = Color(0xFF8E8E93);

  // Used for: Clickable links
  static const Color textLink = primary; 

  // Used for: Text inside the Parchi Card (Name, ID, "Parchi Student")
  static const Color textOnPrimary = Colors.white; 

  // --- Utility Colors ---
  // Used for: "20% OFF" tags on Restaurant cards
